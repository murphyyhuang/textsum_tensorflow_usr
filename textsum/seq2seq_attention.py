...
seq_seq_config = namedtuple("seq_seq_config",
                            ['data_path', 'vocab_path', 'article_key', 'abstract_key',
                             'log_root', 'train_dir', 'eval_dir', 'decode_dir', 'mode',
                             'max_run_steps', 'max_article_sentences', 'max_abstract_sentences',
                             'beam_size', 'eval_interval_secs', 'checkpoint_secs', 'use_bucketing',
                             'truncate_input', 'num_gpus', 'random_seed'])

FLAGS = seq_seq_config(
  "../data/cnn_stories_bin/cnn-train.bin", # data_path
  "../data/cnn_stories_bin/cnn-vocab", # vocab_path
  "article", # article_key
  "abstract", # abstract_key
  "log_root", # log_root
  "log_root/train", # train_dir
  "log_root/eval", # eval_dir
  "log_root/decode", # decode_dir
  "train", # mode
  10000000, # max_run_steps
  800, # max_article_sentences
  2, # max_abstract_sentences
  4, # beam_size
  60, # eval_interval_secs
  60, # checkpoint_secs
  False, # use_bucketing
  False, # truncate_input
  1, # num_gpus
  2333, # random_seed
)
